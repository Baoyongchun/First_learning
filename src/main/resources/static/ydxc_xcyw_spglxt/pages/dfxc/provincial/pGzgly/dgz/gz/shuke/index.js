       ...
       /* mixins: [template1, scspb],*/
        ...
        methods: {
            ...
            saveFile: function () {
                ...
                if(url.indexOf("=")!=-1) {
                    ...
                    console.log("保存ofd："+_config.url.frame.saveQzOfd+"?bh="+bh);
                    var res = this.ocx.saveFile(config.url.frame.saveQzOfd+"?bh="+bh+"&gzOrSz=gz");
                    if(res==true){
        ...
        created: function () {
            ...
            if ( this.ocx) {
                ...
                if(url.indexOf("=")!=-1){
                    var bh = decodeURI(url).substr(url.indexOf("=")+1);
                    var path = _config.url.frame.getMinioFileBySpid+"?bh="+bh;
