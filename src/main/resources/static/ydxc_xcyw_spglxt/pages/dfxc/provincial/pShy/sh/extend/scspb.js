            ...
            mounted: function () {
                ...
                promiseRequest.then(function(data){
                    ...
                    var headDomStr='<tr>'+
                        ...
                        '<td colspan="4" class="fd-td-text fd-40">'+ _this.transUndefined(data.jbxx.cSqdwMc) +'</td>'+
                        '<td colspan="2" class="fd-td-label fd-20">申请部门</td>'+
                        '<td colspan="2" class="fd-td-text fd-20">'+ _this.transUndefined(data.jbxx.cSqbmMc) +'</td>'+
                        '</tr>'+
                        '<tr>'+
                        '<td colspan="2" class="fd-td-label fd-20">查询申请人</td>'+
                        '<td colspan="4" class="fd-td-text fd-40">'+ _this.transUndefined(data.jbxx.cQqrMc) +'</td>'+
                        '<td colspan="2" class="fd-td-label fd-20">协助查询人</td>'+
                        '<td colspan="2" class="fd-td-text fd-20">'+ _this.transUndefined(data.jbxx.cXzqqrMc) +'</td>'+
                        '</tr>'+
                        '<tr>'+
                        '<td colspan="2" class="fd-td-label fd-20">事由</td>'+
                        '<td colspan="4" class="fd-td-text fd-40">'+ _this.transUndefined(data.jbxx.cxsyMc) +'</td>'+
                        '<td colspan="2" class="fd-td-label fd-20">监督检查审查调查对象干部管理权限</td>' +
                        '<td colspan="2" class="fd-td-text fd-20">' + _this.transUndefined(data.jbxx.permissionName) + '</td>' +
                        '</tr>'+
                        '<tr>'+
                        '<td colspan="2" class="fd-td-label">查询审批权限</td>'+
                        '<td colspan="8" class="fd-td-text">'+
                        '查询省（区、市）管干部信息、省（区、市）外信息的，由省（区、市）纪委监委主要领导审批；查询省（区、市）管干部以外其他人员本省（区、市）信息的，由省（区、市）纪委监委分管领导审批'+
                        '</td>'+
                        '</tr>'+
                        '<tr>'+
                        ...
                        '<td colspan="2"><div class="fd-line-height">领导批示<div></td>'+
                        '<td colspan="8" class="fd-height-235-relative"></td>'+
                        '</tr>';
                    ...
                    var leaderDomStr='<div class="fd-leader-wraper">'+
                        ...
                        '<span class="fd-fl">承办人：'+_this.transUndefined(data.jbxx.cCbrMc)+'</span>'+
                        '<span class="fd-fr">联系方式：'+ _this.transUndefined(data.jbxx.cLxfs) +'</span>'+
                        '</div>'+
                        '<div class="clearfix fd-title-05">'+
                        '<span class="fd-fl">审核员：</span>'+
                        '</div>'+
                        '</div>';
                    if(data.jbxx.nMgxx==1){
                                ...
                                if(fdGlobal.checkBrowser().browser=="IE"){
                                    ...
                                    if (i === 0) {
                                        firstCode = '<div class="fd-barCode first"  ><img src="'+ data[i] +'"/></div>' +
                                            '<div class="fd-pageNo first" style="margin-top: 10px;" >承办人：'+_this.cbcMcAndSqrq +'/第1页  共'+ pageTotal+'页</div>';
                                    ...
                                    var firstCode = '';
                                    if (i === 0) {
                                        firstCode = '<div class="fd-barCode fd-chrome-page first" ><img src="'+ data[i] +'"/></div>' +
                                            '<div class="fd-pageNo first" style="margin-top: 10px;" >承办人：'+_this.cbcMcAndSqrq +'/第1页  共'+pageTotal+'页</div>';
                                ...
                                if(item.queriedObjects.cxZrrList!==undefined){
                                    if(item.queriedObjects.cxZrrList.length!=0){
                                        $('.js-table-'+index).append('<tr>'+
                                            ...
                                            '<td class="fd-td-80" colspan="2"><div class="fd-td-div">序号</div></td>'+
                                            '<td class="fd-8" colspan="2"><div class="fd-td-div">姓名</div></td>'+
                                            '<td class="fd-24" colspan="6"><div class="fd-td-div">证件号</div></td>'+
                                            '<td class="fd-12" colspan="3"><div class="fd-td-div">职级</div></td>'+
                                            '<td class="fd-16" colspan="4"><div class="fd-td-div">干部管理权限</div></td>'+
                                            '<td class="fd-28" colspan="6"><div class="fd-td-div">查询项</div></td>'+
                                            '</tr>');
                                    };
                                    var cxZrrDomStr='';
                        ...
                        promiseBarcode.then(function(data){
                            for(var i=0;i<data.length;i++){
                                if(fdGlobal.checkBrowser().browser=="IE"){
                                    ...
                                    var firstCode = '';
                                    if (i === 0) {
                                        firstCode = '<div class="fd-barCode fd-chrome-page first" style="margin-top: -20px;"><img src="'+ data[i] +'"/></div>' +
                                            '<div class="fd-pageNo first" style="margin-top: 30px;">承办人：'+_this.cbcMcAndSqrq +'/第1页  共'+pageTotal+'页</div>';
                                    ...
                                    if(fdGlobal.checkBrowser().version < 50){
                                        ...
                                        //如果是chrome浏览器打印的
                                        var barCodeDomStr='<div class="fd-barCode fd-chrome-page '+ (i==0?'first':'') +'" style="top:'+ _this.positions[i+1].barcode +'px"><img src="'+ data[i] +'"/></div>';
                                        var pageNoDomStr='<div class="fd-pageNo '+ (i==0?'first':'') +'" style="top:'+ _this.positions[i+1].pageNumber +'px">承办人：'+_this.cbcMcAndSqrq +'/第'+(i+1)+'页  共'+pageTotal+'页</div>';
                                    }
                                    // 打印页面的高度
