...
//                                fdGlobal.consoleLogResponse(config.showLog,_this.name+'静态数据',data)
            ...
            atyTreeClick:function(newValue) {
                ...
                if (newValue.treeNodeId != "corp_0" && (newValue.type === 'dept'||newValue.type === 'corp')) {
                    this.showAllDc=true;
                    this.showSelDc=true;
                }else{
                    this.showAllDc=false;
                    this.showSelDc=false;
                }
...
//                                fdGlobal.consoleLogResponse(config.showLog,_this.name+'静态数据',data)
            ...
            exportByFilxter: function (isAll){
                ...
                frame.src = _this.exportOrganByFilter + '?cIds=' + cIds+ '&deptId=' +_this.cDwId +'&userName='+_this.userName+ '&zt='+ _this.statues+'&organType='+ _this.type + '&jsName=';
                setTimeout(function(){
