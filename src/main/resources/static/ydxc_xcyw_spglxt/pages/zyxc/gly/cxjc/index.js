...
define(['extend/template1.js', 'config', 'fdGlobal'], function (template1,_config, fdGlobal) {
    ...
    new Vue({
        ...
        methods: {
            exportCxjc: function (exportType) {
                var _this = this;
                if(!_this.total>0){
                    ...
                    form.attr('action', "/api/v1/cxjcjl/exportCxjc");
                    var input1 = $('<input>');
                    input1.attr('type', "hidden");
                    input1.attr('name', "sqdw");
                    input1.attr('value', _this.cxtj.sqdw);
                    var input2 = $('<input>');
                    input2.attr('type', "hidden");
                    input2.attr('name', "dckssj");
                    input2.attr('value', _this.cxtj.dckssj);
                    var input3 = $('<input>');
                    input3.attr('type', "hidden");
                    input3.attr('name', "dcjssj");
                    input3.attr('value', _this.cxtj.dcjssj);
                    var input4 = $('<input>');
                    input4.attr('type', "hidden");
                    input4.attr('name', "zt");
                    input4.attr('value',  _this.isEmpty(_this.nZt) ? 100 : parseInt(_this.nZt));
                    var input6 = $('<input>');
                    input6.attr('type', "hidden");
                    input6.attr('name', "xxjs");
                    input6.attr('value', _this.cxtj.xxjs);
                    $('body').append(form);
                    form.append(input1);
                    form.append(input2);
                    form.append(input3);
            ...
            getJueSeType: function () {
                ...
                Artery.ajax.post("/api/v1/cxjcjl/getJueSe").then(function (result) {
                    if("cxjcy" == result || "zyxtgly" == result){
                        _this.showCz = false;
                    }else{
                        // _this.showAll =true;
                        _this.showCz = true;
