...
define('Pagination',[], function () {
    function Pagination(options,request){
        var  options=options||{};
        // 总页数
        ...
        // 跳转页
        this.jumpPage=options.jumpPage?options.jumpPage:'';
    ...
    Pagination.prototype={
        ...
        changedCallback: function () {
            var  _this=this;
            _this.request(_this.currentPage,_this.currentSize)
